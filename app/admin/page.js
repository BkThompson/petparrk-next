...
const ADMIN_EMAILS = [
  ...
  "susan@petparrk.com", // ← update with Susan's real email
];

const TABS = ["Submissions", "Pending Vets", "Vets", "Prices", "Users", "Symptom Logs"];
...
const TRIAGE_CONFIG = {
  ...
  see_vet_soon: { color: "#e65100", bg: "#fff3e0", emoji: "🟡", label: "See vet soon" },
...
export default function AdminPage() {
  ...
  useEffect(() => {
    ...
    fetchServices(); fetchUsers(); fetchSymptomLogs(); fetchStats();
  }, [authorized]);
