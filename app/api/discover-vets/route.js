...
const BAY_AREA_ZIPS = [
  ...
  "94501", "94502", // Alameda
  "94541", "94542", "94544", "94545", // Hayward
  "94577", "94578", "94579", // San Leandro
  "94546", "94552", "94555", "94560", "94568", // Castro Valley / Dublin / Fremont
  "94536", "94537", "94538", "94539", // Fremont
  "94550", "94551", // Livermore / Pleasanton
  // Berkeley / Albany / Emeryville / El Cerrito
  "94702", "94703", "94704", "94705", "94706", "94707", "94708", "94709",
  "94710", "94720", "94530", "94608",
  // Contra Costa County
  "94520", "94521", "94523", "94525", "94526", "94528", "94530", "94531",
  "94553", "94556", "94563", "94564", "94565", "94595", "94596", "94597",
  "94598", "94801", "94803", "94804", "94805", "94806", // Richmond
  // Marin County
  "94901", "94903", "94904", "94920", "94925", "94930", "94939", "94941",
  "94945", "94947", "94949", "94950", "94960", "94965", "94970", "94973",
  // San Mateo County
  "94002", "94005", "94010", "94011", "94013", "94014", "94015", "94019",
  "94020", "94021", "94025", "94027", "94028", "94030", "94044", "94061",
  "94062", "94063", "94065", "94066", "94070", "94074", "94080",
  "94401", "94402", "94403", "94404",
  // Santa Clara County
  "94022", "94023", "94024", "94035", "94039", "94040", "94041", "94042",
  "94043", "94085", "94086", "94087", "94088", "94089",
  "94301", "94302", "94303", "94304", "94305", "94306",
  "95002", "95008", "95014", "95032", "95050", "95051", "95054", "95070",
  "95101", "95110", "95112", "95116", "95117", "95118", "95120", "95121",
  "95122", "95123", "95124", "95125", "95126", "95127", "95128", "95129",
  "95130", "95131", "95132", "95133", "95134", "95135", "95136", "95138",
  "95139", "95140",
  // Sonoma County
  "94928", "94931", "94951", "94952", "94954", "94975",
  "95401", "95403", "95404", "95405", "95407", "95409", "95442", "95448",
  "95452", "95472", "95476",
  // Napa County
  "94558", "94559", "94562", "94574", "94576", "94581", "94599",
  // Solano County
  "94510", "94512", "94533", "94534", "94535", "94571", "94585", "94589",
  "94590", "94591", "94592",
];
...
// Clean vet name — strips city tags Google Places sometimes appends in parentheses
// e.g. "Cheap Shots Animal Hospital(SAN LEANDRO)" → "Cheap Shots Animal Hospital"
function cleanVetName(name) {
  if (!name) return name;
  // Remove trailing parenthetical that looks like a location tag (all caps or city-like)
  return name
    .replace(/\s*\([A-Z][A-Z\s]+\)\s*$/, "")  // (SAN LEANDRO), (FREMONT), etc.
    .replace(/\s*\([^)]{1,30}\)\s*$/, (match) => {
      // Also remove mixed-case short parentheticals that look like locations
      const inner = match.replace(/[()]/g, "").trim();
      const words = inner.split(/\s+/);
      // Keep it if it looks like a service descriptor (more than 4 words or has lowercase)
      if (words.length > 4 || /[a-z]/.test(inner)) return match;
      return "";
    })
    .trim();
}
    ...
    for (const zip of zipsToProcess) {
      try {
        ...
        for (const place of places) {
          // Clean the name before any comparison or storage
          const cleanedName = cleanVetName(place.name);

          // Skip if name already exists
          if (existingNames.has(normalizeName(cleanedName))) {
            results.skipped++;
            continue;
          }
          ...
          // Insert into pending_vets with cleaned name
