      ...
      <div className="legal-body">
        <div className="pp-container-text">
          ...
          <div className="legal-section">
            ...
            <p className="legal-p">
              All published prices are based on verified information — never
              estimates, predictions, or figures generated by AI. Where we do
              not hold verified information for a service, no price is shown.
            </p>
            <p className="legal-p">
